  ...
  return (
    <View style={hdrStyles.wrap}>
      <View style={hdrStyles.top}>
        ...
        <Pressable onPress={onClose} hitSlop={10}><Ionicons name="close" size={22} color={LegacyColors.ink} /></Pressable>
      </View>
...
const hdrStyles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: "800", color: LegacyColors.ink, letterSpacing: -0.3 },
  track: { height: 4, backgroundColor: LegacyColors.border, borderRadius: 2, overflow: "hidden" },
  fill: { height: 4, backgroundColor: LegacyColors.accent, borderRadius: 2 },
});
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.searchBar}>
        <Ionicons name="search" size={16} color={LegacyColors.inkSecondary} />
        <TextInput style={styles.searchInput} value={query} onChangeText={setQuery} placeholder="Search restaurants…" placeholderTextColor={LegacyColors.inkDisabled} />
        {query.length > 0 && <Pressable onPress={() => setQuery("")}><Ionicons name="close-circle" size={16} color={LegacyColors.inkDisabled} /></Pressable>}
      </View>
...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: "row", alignItems: "center", gap: 10, marginHorizontal: 16, marginBottom: 8, paddingHorizontal: 14, height: 46, borderRadius: 12, backgroundColor: LegacyColors.card, borderWidth: 1.5, borderColor: LegacyColors.border },
  searchInput: { flex: 1, fontSize: 15, color: LegacyColors.ink },
  list: { paddingHorizontal: 16, paddingBottom: 24 },
  row: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: LegacyColors.border, gap: 12 },
  rowPressed: { backgroundColor: LegacyColors.surface },
  thumb: { width: 48, height: 48, borderRadius: 12, backgroundColor: LegacyColors.accentLight, alignItems: "center", justifyContent: "center" },
  rowBody: { flex: 1 },
  rowName: { fontSize: 15, fontWeight: "600", color: LegacyColors.ink },
  rowMeta: { fontSize: 13, color: LegacyColors.inkSecondary, marginTop: 2 },
});
