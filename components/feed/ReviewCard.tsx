...
const styles = StyleSheet.create({
  ...
  avatarText: { color: LegacyColors.white, fontWeight: "700", fontSize: 15 },
  meta: { flex: 1 },
  name: { fontSize: 14, fontWeight: "600", color: LegacyColors.ink },
  time: { fontSize: 12, color: LegacyColors.inkDisabled, marginTop: 1 },
  stars: { fontSize: 13 },
  comment: { fontSize: 14, color: LegacyColors.inkSecondary, lineHeight: 20 },
});
